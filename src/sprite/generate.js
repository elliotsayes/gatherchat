...
var ANIMATIONS = { no_anim: { len: 1, y: 0 }, idle: { len: 4, y: 1 }, run: { len: 4, y: 2 }, jump: { len: 7, y: 3 } };
var HEAD_ORIGINS = [[0], [0, 1, 2, 1], [-1, -2, 0, 1], [-1, -1, -1, 1, 2, 1, 0]];
...
var colorThemes = [
    ...
    { key: "suit",
    defaults: ["7722aa", "552277"], options: "item" },
    {
        key: "item",
