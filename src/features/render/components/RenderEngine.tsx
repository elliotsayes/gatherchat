...
export const RenderEngine = ({
    ...
    const { optimisticState, activeMovement, move } = useMovement({
        initialState: {
            position:
                state.player.savedPosition ?? state.room.data.spawnPosition,
            direction: "right",
        },
                            ...
                            {flags.showWorld && (
                                <Spring
                                    to={{
                                        x:
                                            stageSize.width / 2 -
                                            (optimisticState.position.x + 1) *
                                                tileSize.x +
                                            tileSize.x / 2,
                                        y:
                                            stageSize.height / 2 -
                                            (optimisticState.position.y + 1) *
                                                tileSize.y +
                                            tileSize.y / 2,
                                    }}
                                >
                                    {(props) => (
                                        ...
                                        >
                                            {world.tileSet}
                                            {state.player.savedPosition !==
                                                undefined && (
                                                <Sprite
                                                    image={
                                                        "assets/sprite/purple.png"
                                                    }
                                                    width={tileSize.x}
                                                    height={tileSize.y}
                                                    x={
                                                        ...
                                                        if (withinThreeTiles) {
                                                            return (
                                                                <InteractableToon
                                                                    ...
                                                                    animationSpeed={
                                                                        otherPlayer.isActivated
                                                                            ? 0.3
                                                                            : 0.1
                                                                    }
                                                                    onclick={() => {
                                                                        events.onPlayerClick(
                                                                            otherPlayer,
                                                                        );
                                                                    }}
                                                                />
                            ...
                            {flags.showPlayer && (
                                ...
                                >
                                    <NamedAvatar
                                        ...
                                        animationName={
                                            activeMovement.state === "moving"
                                                ? "run"
                                                : "idle"
                                        }
                                        flipX={
                                            optimisticState.direction === "left"
                                        }
                                        scale={3}
                                        isPlaying={true}
                                    />
